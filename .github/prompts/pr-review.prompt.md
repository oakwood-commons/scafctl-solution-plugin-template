...
4. **Triage**: For each unresolved comment and pipeline failure, assess whether it's a legit problem with the code. Present the triage summary with recommendations and **stop here** -- wait for the user's approval before applying any fixes
